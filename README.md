...
- **LLM‑driven enrichment** using ChatGPT grounded on *NIST SP 800‑53r5*.
...
| `prompts/` | Three ChatGPT prompt templates |
...
- `NIST.SP.800-53r5.pdf`: Grounding document for ChatGPT

---

Four Lambda agents flow in a serverless chain:
1. **NetGuard Ingestor** – Splits raw PCAP/CSV traffic into 100‑row chunks  
2. **NetGuard Analyzer** – Matches each chunk with anomaly logs and calls ChatGPT  
...
- **Logic**:
  ...
  - Construct structured ChatGPT prompt
...
- Load Handling: Parallel chunking & ChatGPT invocation scaled efficiently.
...
- **Inference API**: ChatGPT (Accure.ai)
- **Ticketing**: JIRA REST API

---

##  Quick Start – Run NetGuard in Your AWS Account
...
ChatGPT_URL=https://tis.accure.ai:9001/query
ChatGPT_TOKEN=<YOUR_TOKEN>
ChatGPT_ORG=<YOUR_ORG_ID>
ChatGPT_CERT_PATH=/opt/python/Chatgpt_cert.pem
